  ...
  return (
    <footer className="bg-[#090d1d] text-white">
      <section className=" p-10 grid md:grid-cols-2 ">
        <div className="flex justify-center flex-col text-md sm:text-lg xl:text-xl font-bold ">
          <p className="mb-10">
            ಶ್ರೀ ಜಗದೀಶ ಗುಡಗುಂಟಿ ಅವರು ಜಮಖಂಡಿ ಕ್ಷೇತ್ರ ಹಾಗೂ ಜನತೆಯ ಸರ್ವತೋಮುಖ
            ಬೆಳವಣಿಗೆಗೆ ಅವಿರತವಾಗಿ ಶ್ರಮಿಸುತ್ತಿದ್ದಾರೆ. ನಾವೂ ಜೊತೆಯಾಗೋಣ,
            ಚಿಕ್ಕಬಳ್ಳಾಪುರದ ಸಮಗ್ರ ಅಭಿವೃದ್ಧಿಯತ್ತ ಹೆಜ್ಜೆ ಹಾಕೋಣ. ಉಜ್ವಲ ಭವಿಷ್ಯದ ಭವ್ಯ
            ರಾಷ್ಟ್ರ ನಿರ್ಮಿಸೋಣ !!
          </p>
          <p className="">ನಿಮ್ಮ ಸಹಕಾರ ಹಾಗೂ ಬೆಂಬಲ ಸದಾ ಇರಲಿ.</p>
        </div>
        <div className="flex flex-col items-center justify-cente p-5">
          ...
          <div className="text-md sm:text-lg xl:text-xl font-bold ">
